...
export default function PdfViewer({ url }: PdfViewerProps) {
  ...
  const handleDocumentLoadSuccess = (info: { numPages: number }) => {
  ...
  return (
    <div ref={containerRef} className="w-full h-full overflow-y-auto flex flex-col items-center">
      ...
      <Document file={file} onLoadSuccess={handleDocumentLoadSuccess} className="w-full flex flex-col items-center" loading={
